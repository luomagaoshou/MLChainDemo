...
+ (void)mlc_setUpMethodDynamically{
    ...
    Method desMethod =  class_getInstanceMethod([originalClass class], @selector(mlc_rootChainMethod));
...
/**
 ...
 @param inv <#inv description#>
 @param sig <#sig description#>
 @param args <#args description#>
 */
+ (void)mlc_setInv:(NSInvocation *)inv withSig:(NSMethodSignature *)sig andArgs:(va_list)args {
